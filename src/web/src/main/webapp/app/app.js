...
*/
    ...
    run.$inject = ['$rootScope', '$location', '$cookieStore', '$http', 'ALL_APP_ROLES', '$templateCache'];
    function run($rootScope, $location, $cookieStore, $http, ALL_APP_ROLES, $templateCache) {
